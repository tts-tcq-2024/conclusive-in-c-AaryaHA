...
**Through this training, I understood the concept of clean coding and its effect. I learnt how to write a code with less cyclometric complexity and to refactor and restructure to improve the readibility.By using these concept, I shall be able to develop a code that is readable and less complex. **
